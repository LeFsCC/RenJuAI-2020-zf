...
{
    QMessageBox box(QMessageBox::Question,QStringLiteral(""),QStringLiteral(""));
    box.setStandardButtons (QMessageBox::Yes|QMessageBox::No);
    box.setButtonText (QMessageBox::Yes,QString(QStringLiteral("")));
    box.setButtonText (QMessageBox::No,QString(QStringLiteral("")));
    return box.exec();
}
